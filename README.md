...
- **Componentes Standalone**: Preferir standalone sobre módulos
- **Change Detection**: OnPush para mejor performance
- **TypeScript**: Strict mode habilitado
- **SCSS**: Usar variables y mixins reutilizables
...
- Revisar interceptor en `core/interceptors/auth.interceptor.ts`

**API no responde**
- Verificar que backend está en `http://localhost:3000`
- Chequear `src/environments/environment.ts`
- Abrir DevTools → Network para ver peticiones
...
**Versión:** 0.0.0  
**Autor:** Jeimy Andrea Díaz Gaitán
